...
- [~] 1.3 Build **Stage 0 (Pre-A1/A1) curriculum in full** — units and lessons following the template,
      ...
      → unit map done: `curriculum/stage0/00-stage0-unit-map.md` (11 units, ~55–60 lessons); Units 0–4 authored in full (5/11) — Units 0–2 are enough to launch the founding cohort; Units 5–10 remain
